    ...
    <div className="min-h-screen w-full bg-white">
      ...
      <header className="w-full flex flex-col sm:flex-row items-center justify-between px-2 sm:px-8 py-2 sm:py-4 border-b border-black gap-2 sm:gap-0">
        <div className="flex items-center gap-2">
          <img
            src="/valhalla-icon.png"
            alt="Valhalla Logo"
            className="h-8 w-8"
          />
          <span className="font-bold text-xl tracking-widest uppercase text-black">
            Valhalla
          </span>
        </div>
        <Link
      ...
      <section className="w-full bg-white text-black py-8 md:py-24 px-2 sm:px-8">
        <h1 className="text-2xl md:text-6xl font-bold mb-4 uppercase tracking-wider">
          VALHALLA JIU JITSU +
        </h1>
        <p className="text-base md:text-2xl mb-8 max-w-2xl">
          Domina el arte del Jiu Jitsu con nuestras rutas de aprendizaje
          estructuradas y contenido de alta calidad
        </p>
      </section>
      {/* Rutas de Aprendizaje alineadas a la izquierda */}
      <section className="w-full py-2 md:py-8 px-2 sm:px-8">
        <div className="max-w mx-auto">
          <h2 className="text-lg md:text-2xl font-bold uppercase tracking-wide mb-6 text-left text-black">
